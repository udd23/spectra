...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $event_name = $conn->real_escape_string(trim($_POST['event-name']));
    $date_of_event = $conn->real_escape_string(trim($_POST['date-of-event']));
    ...
    $content = isset($_POST['content']) ? (int)$_POST['content'] : null;
    $speakers = isset($_POST['speakers']) ? (int)$_POST['speakers'] : null;
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO event_survey (full_name, email, phone_number, event_name, date_of_event, satisfaction, likelihood, liked_most, disliked, additional_comments, organization, content, speakers, contact, photo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssssssiiiss", $full_name, $email, $phone_number, $event_name, $date_of_event, $satisfaction, $likelihood, $liked_most, $disliked, $additional_comments, $organization, $content, $speakers, $contact, $photo);
        ...
        function handleSubmit(event) {
            ...
            formContainer.innerHTML = `
                ...
                <div class="bg-gray-100 p-4 rounded-lg">
                    ...
                    <p><strong>Event Name:</strong> ${event.target.elements['event-name'].value}</p>
                    <p><strong>Date of Event:</strong> ${event.target.elements['date-of-event'].value}</p>
                    <p><strong>Satisfaction Level:</strong> ${event.target.elements['satisfaction'].value}</p>
                    <p><strong>Likelihood to Attend Future Events:</strong> ${event.target.elements['likelihood'].value}</p>
                    ...
                    <p><strong>Event Organization Rating:</strong> ${event.target.elements['organization'].value}</p>
                    <p><strong>Event Content Rating:</strong> ${event.target.elements['content'].value}</p>
                    <p><strong>Event Speakers Rating:</strong> ${event.target.elements['speakers'].value}</p>
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-center">
            ...
            <div id="form-container" class="bg-white text-gray-800 p-6 rounded-lg shadow-lg w-full max-w-2xl">
                <h2 class="text-xl font-bold mb-4">Event Feedback Survey</h2>
                <form onsubmit="handleSubmit(event)">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="event-name" class="w-full p-2 border border-gray-300 rounded" placeholder="Enter event name">
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Date of Event:</label>
                        <input type="date" name="date-of-event" class="w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">How satisfied are you with the event overall?</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700">How likely are you to attend our future events?</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700">What did you like most about the event?</label>
                        <textarea name="liked-most" class="w-full p-2 border border-gray-300 rounded" placeholder="Enter your feedback"></textarea>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">What did you dislike about the event?</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700">Rate the event organization:</label>
                        <div class="flex space-x-2">
                            <label class="flex items-center">
                                <input type="radio" name="organization" value="1" class="mr-2"> 1
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="organization" value="2" class="mr-2"> 2
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="organization" value="3" class="mr-2"> 3
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="organization" value="4" class="mr-2"> 4
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="organization" value="5" class="mr-2"> 5
                            </label>
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Rate the event content:</label>
                        <div class="flex space-x-2">
                            <label class="flex items-center">
                                <input type="radio" name="content" value="1" class="mr-2"> 1
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="content" value="2" class="mr-2"> 2
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="content" value="3" class="mr-2"> 3
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="content" value="4" class="mr-2"> 4
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="content" value="5" class="mr-2"> 5
                            </label>
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Rate the event speakers:</label>
                        <div class="flex space-x-2">
                            <label class="flex items-center">
                                <input type="radio" name="speakers" value="1" class="mr-2"> 1
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="speakers" value="2" class="mr-2"> 2
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="speakers" value="3" class="mr-2"> 3
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="speakers" value="4" class="mr-2"> 4
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="speakers" value="5" class="mr-2"> 5
                            </label>
                        </div>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700">Upload a photo from the event (optional):</label>
